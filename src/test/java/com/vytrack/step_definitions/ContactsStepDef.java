...
//        System.out.println(menuOptions);               //[Fleet, Customer, Activities, System]
    ...
    public void the_user_logs_in_using_following_credentials(Map<String, String> userInfo) {   //tek bir user a ait bircok Key and values leri tek Map de toplayabilirim, birden cok user olsa idi List<Map<K, V>> olackti
